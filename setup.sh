...
xterm -T "☣ INSTALL DEPENDENCIES ☣" -geometry 100x30 -e "sudo apt-get install lib32z1 lib32ncurses5 lib32stdc++6 python2-minimal python2-pip-whl python2-dev build-essential -y && pip3 install names"
sleep 1
